...
class Whiskey(db.Model):
    ...
    def __init__(self,variety,distiller,year,tasting_notes,user_token, id = ''):
        self.id = self.set_id()
    ...
    def __repr__(self):
        return f'The following whiskey has been added to your collection: {self.distiller}'
...
class WhiskeySchema(ma.Schema):
    class Meta:
        fields = ['id', 'variety','distiller','year', 'tasting_notes']

whiskey_schema = WhiskeySchema()
whiskeys_schema = WhiskeySchema(many=True)

# 3c32556c8d481fd2cbe2233da6b3e3d9ef6a1b58328010ae